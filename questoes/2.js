function atualizaContagem() {
    ...
    document.querySelector('#conta-maior-18').value = maior;
    document.querySelector('#conta-menor-18').value = menor;
}

//document.querySelector('#conta-maior-18').value = 0;
//document.querySelector('#conta-menor-18').value = 0;
...
document
    ...
    .addEventListener('click', function (event) {
        ...
        btnRemove.addEventListener('click', function (event) { alert("Ainda nao sei fazer em js.") });
